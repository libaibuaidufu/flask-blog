...
def index():
    ...
    return render_template('index.html',titles=titles,fenleis=fenleis,tuijianposts=tujianposts, liuyans=liuyans, rejipost=rejipost,
...
def post(id):
    ...
    return render_template('post.html',zuoze=zuoze, filelist=images,b=b,isExists=isExists, fenleis=fenleis,post=post, pythonposts=pythonposts, shujukuposts=shujukuposts,
                           pacongposts=pacongposts,
